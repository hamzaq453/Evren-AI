      ...
      <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl">
        ...
        <div className="absolute inset-0 flex flex-col justify-end px-5 py-4 text-center transition-opacity duration-300 bg-[#9984D4] bg-opacity-75 opacity-0 hover:opacity-100">
          <div className="bg-primaryy p-2">
            ...
            <p className="mb-1 sm:mb-2 text-[9px] sm:text-[11px] font-semibold text-white">
              {props.position}
            </p>
            <div className="flex items-center justify-center space-x-3">
              <a
                href="/"
                className="text-white transition-colors duration-300 hover:text-ternary"
              >
              ...
              <a
                href="/"
                className="text-white hover:text-ternary transition-colors duration-300 "
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 sm:h-5">
