        ...
        <div className="services flex flex-col gap-5 text-black">
          <div>
            ...
            <ul className="text-sm p-[0] m-[0]  mt-[15px] text-black">
              ...
              <li>
                <Link href="/Service2" className="linkage">
                  - Machine & Deep Learning Solutions
                </Link>
              </li>
              <li>
                <Link href="/Service3" className="linkage">
                  - Chatbots
                </Link>
              </li>
              <li>
                <Link href="/Service4" className="linkage">
                  - AI Agents
                </Link>
              </li>
              <li>
                <Link href="/Service5" className="linkage">
                  - Software Development
                </Link>
              </li>
              <li>
                <Link href="/Service6" className="linkage">
                  - Computer Vision
                </Link>
              </li>
              <li>
                <Link href="/Service7" className="linkage">
                  - Generative AI
                </Link>
              </li>
              <li>
                <Link href="/Service8" className="linkage">
        ...
        <div className="quicklinks flex flex-col gap-5 text-black">
          <div>
            ...
            <ul className="text-sm p-[0] m-[0] mt-[15px] ">
              ...
              <li>
                <Link href="/about" className="linkage">
                  About us
                </Link>
              </li>
              <li>
                <Link href="/casestudy" className="linkage">
                  Case Studies
                </Link>
              </li>
              <li>
                <Link href="/blog" className="linkage">
                  Blog
                </Link>
              </li>
            </ul>
            ...
            <ul className="text-sm p-[0] m-[0] mt-[15px] ">
              ...
              <div class=" h-auto flex gap-3 flex-wrap middle:justify-center py-[15px] m-[0]  ">
                ...
                <Link href="https://www.instagram.com/evren_ai/" target="_blank">
                  {" "}
                  <button class="w-9 h-9 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-500 focus:outline-none">
                    <svg
                      class="fill-primaryy relative z-10 transition-all duration-500 group-hover:fill-white"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      viewBox="0 0 51 51"
                ...
                {/* x.com */}
                <Link href="https://x.com/Evren_ai" target="_blank">
                  {" "}
                  <button class="w-9 h-9 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-300 outline-none focus:outline-none">
                    <svg
                ...
                <Link href="https://www.threads.net/@evren_ai" target="_blank">
                  <button class="w-9 h-9 flex items-center justify-center rounded-full relative overflow-hidden bg-white shadow-md shadow-gray-200 group transition-all duration-300 outline-none focus:outline-none">
                    <svg
                      class="fill-primaryy z-10 transition-all duration-300 group-hover:fill-white"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                {/* tiktok */}
                <Link href="https://www.tiktok.com/@evren_ai" target="_blank">
                  {" "}
                  <button class="w-9 h-9 flex items-center justify-center relative overflow-hidden rounded-full bg-white shadow-md shadow-gray-200 group transition-all duration-300 focus:outline-none">
                    <svg
                      class="fill-primaryy relative z-10 transition-all duration-300 group-hover:fill-white"
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                    ...
                    <div class="absolute top-full left-0 w-full h-full rounded-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-black via-black to-red-600 z-0 transition-all duration-500 group-hover:top-0"></div>
                  </button>
                </Link>
              </div>
            </ul>
