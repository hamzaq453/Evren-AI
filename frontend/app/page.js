    ...
    <>
      ...
      <div className="m-0">
        <div class="relative mx-auto max-w-5xl text-center pt-5 mt-14 middle:pt-10">
          ...
          <p class="mx-auto my-4 w-[90%] bg-transparent text-center font-medium leading-relaxed tracking-wide text-gray-400 large:text-base middle:text-sm small:text-xs middle:max-w-lg small:max-w-sm middle:my-2 text-justify ">
