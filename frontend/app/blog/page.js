          ...
          <section class="text-gray-600 body-font">
            <div class="container px-5 py-14 mx-auto">
              <div class="flex flex-wrap -m-4">
                <div class="p-3 mb-8 lg:w-1/3 md:w-1/2">
                  <div class="min-h-[590px] small:min-h-[520px] bg-ternary bg-opacity-75 p-5 rounded-lg overflow-hidden text-center relative transition duration-300 transform shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl pb-3">
                ...
                <div class="p-3 mb-8 lg:w-1/3 md:w-1/2">
                  <div class="min-h-[590px] small:min-h-[520px] bg-ternary bg-opacity-75 p-5 rounded-lg overflow-hidden text-center relative transition duration-300 transform shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl pb-3">
                    ...
                    <p class="leading-relaxed mb-9 text-[15px] small:text-[13px]">
                      ...
                      faster, more personalized, and efficient. This post
                      explores how AI is changing customer connections, its
                      benefits, and future trends, offering valuable insights
                ...
                <div class="p-3 mb-8 lg:w-1/3 md:w-1/2 ">
                  <div class="min-h-[590px] small:min-h-[500px] bg-ternary bg-opacity-75 p-5 rounded-lg overflow-hidden text-center relative transition duration-300 transform shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl pb-3">
                    <div className="w-full">
                      <Image
                        priority={true}
                        quality={80}
