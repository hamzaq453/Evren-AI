    ...
    <>
      <div className="container whyusdiv ">
        <div className="row justify-content-center">
          ...
          <div className="col-lg-5 m-3 ">
            <Image src='/homepage/whyus/tailered Solution.png' priority={true} width={100} height={50} alt='Tailered Solution Image' className='whyusimg rounded mx-auto d-block ' />
          </div>
        </div>
        <div className="row justify-content-center">
          <div className="col-lg-5 m-3 ">
            <Image src='/homepage/whyus/human centered approach.png' priority={true} width={100} height={50} alt='human Centered Approach Image' className='whyusimg rounded mx-auto d-block ' />
          </div>
          <div className="col-lg-5 m-3 ">
            <div className="container ml-md-auto ">
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-5 m-3 ">
            <Image src='/homepage/whyus/results (1).png' priority={true} width={100} height={50} alt='Result Image' className='whyusimg rounded mx-auto d-block ' />
          </div>
        </div>
        <div className="row justify-content-center">
          <div className="col-lg-5 m-3 ">
            <Image src='/homepage/whyus/flexibility.png' priority={true} width={100} height={50} alt='Flexibility Image' className='whyusimg rounded mx-auto d-block ' />
          </div>
          <div className="col-lg-5 m-3 ">
            <div className="container ml-md-auto ">
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-5 m-3 ">
            <Image src='/homepage/whyus/trust (1).png' priority={true} width={100} height={50} alt='Trust Image' className='whyusimg rounded mx-auto d-block ' />
          </div>
        </div>
        <div className="row justify-content-center">
          <div className="col-lg-5 m-3 ">
            <Image src='/homepage/whyus/expert.png' priority={true} width={100} height={50} alt='Expert Team Image' className='whyusimg rounded mx-auto d-block ' />
          </div>
          <div className="col-lg-5 m-3 ">
            <div className="container ml-md-auto ">
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-5 m-3 ">
            <Image src='/homepage/whyus/support (1).png' priority={true} width={100} height={50} alt="Support Image" className='whyusimg rounded mx-auto d-block ' />
          </div>
        </div>
      </div>
    </>
